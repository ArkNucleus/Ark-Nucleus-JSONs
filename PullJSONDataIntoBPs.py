...
# LANGUAGES
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-Localization\\languages.json","r", encoding="utf8") as jsonFile:
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\struct-painter-uihack.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-color.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-category.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-object.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["OBJECT"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-string.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["STRING"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-boolean.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["BOOLEAN"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-int.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["INT"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-array-string.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["ARRAY-STRING"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-array-object.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    edit_widgets["ARRAY-OBJECT"] = json.dumps(jsonData)

with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-magic-array-player.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
# PRE-BUILD
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\mod_info.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\item_info.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\spawn.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\struct_painter.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\advanced3d_view.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\item-modal.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
# BASE WIDGET
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\base-widget\\du_base-basic-error.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\base-widget\\du_base-basic-modal.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\base-widget\\du_base-basic-notif.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
# TABBED PANEL
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-panel-tabbed.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("F:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\du-edit-dropdown-default-item.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
