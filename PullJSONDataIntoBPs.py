...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-Localization\\languages.json","r", encoding="utf8") as jsonFile:
    ...
    change_blueprint_default_value("/Ark-Nucleus/CoreBPs/Nucleus_BaseSharedData.Nucleus_BaseSharedData_C", "Languages", json.dumps(jsonData))
...
# NUCLEUS CCA NO MOD INFO UI
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\mod-ui\\no-mod-custom-info.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/CoreBPs/CCA/Ark-Nucleus_CCA.Ark-Nucleus_CCA_C", "My_NoCustomInfoPage", json.dumps(jsonData))
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\main-page\\disabled-server-info-page.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/CoreBPs/CCA/Ark-Nucleus_CCA.Ark-Nucleus_CCA_C", "Nucleus_DisabledServerInfoPage", json.dumps(jsonData))
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\main-page\\main-page-installed-mods.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\main-page\\main-page-encyclopedia.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\main-page\\main-page-all-logs.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
client_setting = {}
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\client-settings-uihacks.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    client_setting["UIHACKS"] = json.dumps(jsonData)

with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\client-settings-colors.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\server-settings-general.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    server_setting["GENERAL"] = json.dumps(jsonData)

with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\server-settings-api.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    server_setting["API"] = json.dumps(jsonData)

with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\server-settings-localization.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    server_setting["LOCALIZATION"] = json.dumps(jsonData)

with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\server-settings-permissions.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
player_setting = {}
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\nucleus-cca\\settings\\player-settings-general.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\pre-build\\item_info.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/DynamicUI/Widgets/PreBuiltComps/DU_PreBuilt_ItemInfo_v1.DU_PreBuilt_ItemInfo_v1_C", "N_BaseWidget_StaticUIConfig", json.dumps(jsonData))
...
with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\item-modal.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/DynamicUI/Widgets/ListItems/DU_Item_PrimalItemDino_v2.DU_Item_PrimalItemDino_v2_C", "DU_Item_ModalUIConfig", json.dumps(jsonData))


with open("G:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\temp.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/CoreBPs/CCA/Ark-Nucleus_CCA.Ark-Nucleus_CCA_C", "Nucleus_FakeCFData", json.dumps(jsonData))
